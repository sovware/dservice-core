...
function dservice_custom_style()
{
    ...
    <style>
        ...
        .btn-checkbox label input:checked + span, .directorist-map-search .directorist-advanced-filter__action .directorist-btn + .directorist-btn, .custom-control .custom-control-input:checked ~ .check--select, .custom-control .custom-control-input:checked ~ .radio--select,
        .ads-advanced .price-frequency .pf-btn input:checked + span,
        #directorist.atbd_wrapper.directorist-checkout-form #atbdp-checkout-form #atbdp_pay_notpay_btn .btn-primary,
        #directorist.atbd_wrapper .btn.btn-primary,
        .keep_signed input[type="checkbox"]:checked + label:before,
        ...
        .woocommerce div.product form.cart .button:hover, .btn-gradient:hover, .leaflet-pane .marker-cluster-small {
        ...
        .atbdb_content_module_contents .pagination .active a, .directorist-listing-single .directorist-listing-single__meta .directorist-listing-single__meta--right .dservice-grid-cont-btn, .directorist-pagination .page-numbers.current, .directorist-pagination .page-numbers:hover, .directorist-user-dashboard__nav .directorist-tab__nav__action .directorist-btn--logout {
        ...
        .pricing .pricing__title h4 .atbd_plan-active, .directorist-booking-single .directorist-list-box-listing__content .directorist-booking-list-actions .directorist-btn.directorist-btn-success {
        ...
        .woocommerce .woocommerce-order #login_modal .status span.woocommerce-thankyou-order-received, .dservice_plane_name .form-vertical .modal-header p a, .atbd_badge_open, .directorist-listing-single .directorist-listing-single__info .atbd_badge.atbd_badge_open, .directorist-listing-single .directorist-listing-single__info .directorist-badge.directorist-badge-open {
        ...
        .directorist-listing-single .directorist-badge.directorist-badge-featured, .dservice-dashboard-no-listing, .atbd_upper_badge .atbd_badge.atbd_badge_featured, .atbd_listing_thumbnail_area .atbd_lower_badge .atbd_badge_featured, .directorist-booking-single .directorist-list-box-listing__content .directorist-booking-list-actions .directorist-btn.directorist-btn-warning {
